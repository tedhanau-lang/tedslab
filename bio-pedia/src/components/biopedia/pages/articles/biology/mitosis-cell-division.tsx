...
const topicTags = ["Cell Biology", "Division", "Reproduction"];

export default function MitosisandCellDivisionPage() {
  return (
    <AppShell
      rail={
      ...
      <div className="max-w-5xl">
          ...
          <div className="grid gap-6 p-6 md:grid-cols-[1.3fr_1fr] md:items-center">
            <div>
              ...
              <p className="mt-4 max-w-xl text-sm leading-relaxed text-muted-foreground">
                Mitosis is the process of nuclear division by which a single parent cell divides to produce two genetically identical daughter cells. This process is fundamental to growth, tissue repair, and asexual reproduction in eukaryotic organisms.
              </p>
        ...
        <section className="mt-8 rounded-2xl border border-border bg-card/80 p-6">
          ...
          <div className="mt-6 space-y-5 text-base leading-relaxed text-muted-foreground">
            <p>
              How cells divide to produce two identical daughter cells. This article explores the fundamental concepts, processes, and applications.
            </p>
          </div>
        </section>
